...
if(nf==1){
  ...
  cat("Ts[1,1] ~ dgamma(1,1)",file="bikemodel.txt",sep="\n",append=TRUE)
...
cat("# Individual consumption probabilities correlated among foods (if many foods):",file="bikemodel.txt",sep="\n",append=TRUE)
if(nf>1){
if(between.user.pvar==1){    
cat("logitp[r,1:nf] ~ dmnorm(logitp0[1:nf],Tp[1:nf,1:nf])",file="bikemodel.txt",sep="\n",append=TRUE)
}
if(between.user.pvar==0){
cat("for(j in 1:nf){",file="bikemodel.txt",sep="\n",append=TRUE)  
cat("logitp[r,j] <- logitp0[j]",file="bikemodel.txt",sep="\n",append=TRUE)
cat("}",file="bikemodel.txt",sep="\n",append=TRUE) 
}  
}
if(nf==1){
if(between.user.pvar==1){  
cat("logitp[r,1] ~ dnorm(logitp0[1],Tp[1,1])",file="bikemodel.txt",sep="\n",append=TRUE)  
}
if(between.user.pvar==0){
cat("logitp[r,1] <- logitp0[1]",file="bikemodel.txt",sep="\n",append=TRUE)  
}  
}
cat("for(j in 1:nf){",file="bikemodel.txt",sep="\n",append=TRUE)
cat("for(t in 1:nd){",file="bikemodel.txt",sep="\n",append=TRUE)
cat("usedays[r,j,t] ~ dbern(p[r,j,t])",file="bikemodel.txt",sep="\n",append=TRUE)
cat("# Probability to consume (individual r, food j):",file="bikemodel.txt",sep="\n",append=TRUE)
cat("p[r,j,t] <-  exp(logitp[r,j])/(1+exp(logitp[r,j])) ",file="bikemodel.txt",sep="\n",append=TRUE)
cat("}}}",file="bikemodel.txt",sep="\n",append=TRUE)
...
if(nf>1){
  if(between.user.pvar==0){
    cat("#Tp simulated from prior but not used if no between-user variability",file="bikemodel.txt",sep="\n",append=TRUE)    
  }
cat("Tp[1:nf,1:nf] ~ dwish(DI[1:nf,1:nf],nf2)",file="bikemodel.txt",sep="\n",append=TRUE)
cat("# For optional outputs: evaluate correlation matrix between food type frequencies",file="bikemodel.txt",sep="\n",append=TRUE)
cat("#Sp[1:nf,1:nf] <- inverse(Tp[1:nf,1:nf])",file="bikemodel.txt",sep="\n",append=TRUE)
cat("#for(ii in 1:nf){  ",file="bikemodel.txt",sep="\n",append=TRUE)
cat("#for(jj in 1:nf){  ",file="bikemodel.txt",sep="\n",append=TRUE)
cat("#CORlogitp[ii,jj] <- (Sp[ii,jj])/((sqrt(Sp[ii,ii]))*(sqrt(Sp[jj,jj])))",file="bikemodel.txt",sep="\n",append=TRUE)
cat("#}}",file="bikemodel.txt",sep="\n",append=TRUE)
}
if(nf==1){
  if(between.user.pvar==0){
    cat("#Tp simulated from prior but not used if no between variability",file="bikemodel.txt",sep="\n",append=TRUE)    
  }  
cat("Tp[1,1] ~ dgamma(1,1)",file="bikemodel.txt",sep="\n",append=TRUE)  
}
if(nf>1){
...
cat("# Consumption frequencies",file="bikemodel.txt",sep="\n",append=TRUE)
cat("for(j in 1:nf){",file="bikemodel.txt",sep="\n",append=TRUE)
cat("# Individual consumption probabilities:",file="bikemodel.txt",sep="\n",append=TRUE)                
cat("ppred[j] <- exp(logitppred[j])/(1+exp(logitppred[j]))   ",file="bikemodel.txt",sep="\n",append=TRUE)
cat("}",file="bikemodel.txt",sep="\n",append=TRUE)
cat("# Individual consumption logit-probabilities:",file="bikemodel.txt",sep="\n",append=TRUE)
if(nf>1){
  if(between.user.pvar==1){
  cat("logitppred[1:nf] ~ dmnorm(logitp0[1:nf],Tp[1:nf,1:nf])",file="bikemodel.txt",sep="\n",append=TRUE)
  }
  if(between.user.pvar==0){
    cat("for(j in 1:nf){",file="bikemodel.txt",sep="\n",append=TRUE)
    cat("logitppred[j] <- logitp0[j]",file="bikemodel.txt",sep="\n",append=TRUE)
    cat("}",file="bikemodel.txt",sep="\n",append=TRUE)
  }
}
if(nf==1){
  if(between.user.pvar==1){ 
  cat("logitppred[1] ~ dnorm(logitp0[1],Tp[1,1])",file="bikemodel.txt",sep="\n",append=TRUE)  
  }
  if(between.user.pvar==0){ 
  cat("logitppred[1] <- logitp0[1]",file="bikemodel.txt",sep="\n",append=TRUE)  
  }
}
