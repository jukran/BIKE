   ...
   output$distPlot1 <- renderPlot({
     ...
     for(i in 1:nfused){
        ...
        if(scale=="Logarithmic"){
         maxx <- mean(mucK[,hazardindexK[h],foodindex[i]]+2*sigcK[,hazardindexK[h],foodindex[i]])
         minn <- mean(mucK[,hazardindexK[h],foodindex[i]]-2*sigcK[,hazardindexK[h],foodindex[i]])
        plot(density(mucK[,hazardindexK[h],foodindex[i]]/log(10)),col="darkgray",lwd=3,main=paste(hazardnamesusedK[h],"in",foodnamesused[i]),xlab="logConcentration+",ylab="",xlim=c(minn/log(10),maxx/log(10))) 
        polygon(density(mucK[,hazardindexK[h],foodindex[i]]/log(10)),col="lightgray")
        # mark data points and possible LOD and LOQ values for censored data:
        rug(logcK[hazardindexK[h],foodindex[i],]/log(10),lwd=2.5,col="red",quiet=TRUE)
        rug(logLOQK[hazardindexK[h],foodindex[i],]/log(10),lwd=4.5,col="green",quiet=TRUE)
        ...
        legend("topright",paste(c("prev(%) 2.5%p","prev(%) 50%p","prev(%) 97.5%p"),round(quantile(100*pK[,hazardindexK[h],foodindex[i]],c(0.025,0.5,0.975),names=FALSE),2) ))  
        } # end of if density
        ...
        if(input$selectdist=="Cumulative"){
          ...
          if(scale=="Logarithmic"){
            maxx <- mean(mucK[,hazardindexK[h],foodindex[i]]+2*sigcK[,hazardindexK[h],foodindex[i]])
            minn <- mean(mucK[,hazardindexK[h],foodindex[i]]-2*sigcK[,hazardindexK[h],foodindex[i]])                                                               
            plot(sort(mucK[,hazardindexK[h],foodindex[i]]/log(10)),cump,lwd=3,main=paste(hazardnamesusedK[h],"in",foodnamesused[i]),xlab="logConcentration+",ylab="",xlim=c(minn/log(10),maxx/log(10)),type="l") 
            # mark data points and possible LOD and LOQ values for censored data:
            rug(logcK[hazardindexK[h],foodindex[i],]/log(10),lwd=2.5,col="red",quiet=TRUE)
            rug(logLOQK[hazardindexK[h],foodindex[i],]/log(10),lwd=4.5,col="green",quiet=TRUE)
            rug(logLODK[hazardindexK[h],foodindex[i],]/log(10),lwd=4.5,col="blue",quiet=TRUE)
          ...
          legend("bottomright",paste(c("prev(%) 2.5%p","prev(%) 50%p","prev(%) 97.5%p"),round(quantile(100*pK[,hazardindexK[h],foodindex[i]],c(0.025,0.5,0.975),names=FALSE),2) ))  
        } # end of if cumulative
     ...
     for(i in 1:nfused){
         ...
         if(scale=="Logarithmic"){
           maxx <- mean(mucM[,hazardindexM[h],foodindex[i]]+2*sigcM[,hazardindexM[h],foodindex[i]])
           minn <- mean(mucM[,hazardindexM[h],foodindex[i]]-2*sigcM[,hazardindexM[h],foodindex[i]])
         plot(density(mucM[,hazardindexM[h],foodindex[i]]/log(10)),col="darkgray",lwd=3,main=paste(hazardnamesusedM[h],"in",foodnamesused[i]),xlab="logConcentration+",ylab="",xlim=c(minn/log(10),maxx/log(10))) 
         polygon(density(mucM[,hazardindexM[h],foodindex[i]]/log(10)),col="lightgray")
         # mark data points and possible LOD and LOQ values for censored data:
         rug(logcM[hazardindexM[h],foodindex[i],]/log(10),lwd=2.5,col="red",quiet=TRUE)
         rug(logLOQM[hazardindexM[h],foodindex[i],]/log(10),lwd=4.5,col="green",quiet=TRUE)
         ...
         legend("topright",paste(c("prev(%) 2.5%p","prev(%) 50%p","prev(%) 97.5%p"),round(quantile(100*pM[,hazardindexM[h],foodindex[i]],c(0.025,0.5,0.975),names=FALSE),2) ))   
         } # end of if density
         ...
         if(input$selectdist=="Cumulative"){
           ...
           if(scale=="Logarithmic"){
             maxx <- mean(mucM[,hazardindexM[h],foodindex[i]]+2*sigcM[,hazardindexM[h],foodindex[i]])
             minn <- mean(mucM[,hazardindexM[h],foodindex[i]]-2*sigcM[,hazardindexM[h],foodindex[i]])
             plot(sort(mucM[,hazardindexM[h],foodindex[i]]/log(10)),cump,lwd=3,main=paste(hazardnamesusedM[h],"in",foodnamesused[i]),xlab="logConcentration+",ylab="",xlim=c(minn/log(10),maxx/log(10)),type="l") 
             # mark data points and possible LOD and LOQ values for censored data:
             rug(logcM[hazardindexM[h],foodindex[i],]/log(10),lwd=2.5,col="red",quiet=TRUE)
             rug(logLOQM[hazardindexM[h],foodindex[i],]/log(10),lwd=4.5,col="green",quiet=TRUE)
             rug(logLODM[hazardindexM[h],foodindex[i],]/log(10),lwd=4.5,col="blue",quiet=TRUE)
           ...
           legend("bottomright",paste(c("prev(%) 2.5%p","prev(%) 50%p","prev(%) 97.5%p"),round(quantile(100*pM[,hazardindexM[h],foodindex[i]],c(0.025,0.5,0.975),names=FALSE),2) ))
         } # end of if cumulative
     ...
     if(is.element("Consumptions",theresults)){
       ...
       if(nfused>0){
           ...
           for(i in 1:nfused){
             ...
             legend("topright",paste(c("freq(%) 2.5%p","freq(%) 50%p","freq(%) 97.5%p"),round(quantile(100*ppred[,foodindex[i]],c(0.025,0.5,0.975),names=FALSE),2) )) 
             ...
             if(input$selectdist=="Cumulative"){
               ...
               legend("bottomright",inset=0.04,cex=0.55,paste(c("freq(%) 2.5%p","freq(%) 50%p","freq(%) 97.5%p"),round(quantile(100*ppred[,foodindex[i]],c(0.025,0.5,0.975),names=FALSE),2) )) 
             ...
             if(input$selectscale=="Logarithmic"){
               ...
               legend("bottomright",paste(c("freq(%) 2.5%p","freq(%) 50%p","freq(%) 97.5%p"),round(quantile(100*ppred[,foodindex[i]],c(0.025,0.5,0.975),names=FALSE),2) )) 
               # distribution of acute consumptions (log):
               logsmean <- sort(mus0[,foodindex[i]]+muw)
               maxx <- mean(mus0[,foodindex[i]]+muw+3.1*sqrt(Ss0[,foodindex[i],foodindex[i]]+sigs[,foodindex[i]]^2+sigw^2))
               minn <- mean(mus0[,foodindex[i]]+muw-3.1*sqrt(Ss0[,foodindex[i],foodindex[i]]+sigs[,foodindex[i]]^2+sigw^2))
...
###########################################################################   
         ...
         for(i in 1:nfused){
           ...
           if(scale=="Logarithmic"){
             ...
             maxx <- quantile(logRK[foodindex[i],hazardindexK[h]]+mus0[,foodindex[i]]
                              ...
                              +0.5*sigcK[,hazardindexK[h],foodindex[i]]^2
                              +2*sqrt(Ss0[,foodindex[i],foodindex[i]]),0.975,names=FALSE) 
             plot(density(logmeanexposure/log(10)),main=paste(hazardnamesusedK[h],"from",foodnamesused[i],"(chronic)"),xlab="logC.exposure/bw+",ylab="",xlim=c(minn/log(10),maxx/log(10)),lwd=3) 
             polygon(density(logmeanexposure/log(10)),col="lightgray")
             legend("topright",paste(c("expo(%) 2.5%p","expo(%) 50%p","expo(%) 97.5%p"),round(quantile(100*ppred[,foodindex[i]],c(0.025,0.5,0.975),names=FALSE),3) ))
             mc <- round(seq(1,input$Iterations-burnin,length=25),0)   
             for(n in 1:25){ # variability distributions for chronic exposures (log) 
               lines(seq(minn/log(10),maxx/log(10),length=100),
                     dnorm(seq(minn/log(10),maxx/log(10),length=100),
           ...
           legend("topright",paste(c("expo(%) 2.5%p","expo(%) 50%p","expo(%) 97.5%p"),round(quantile(100*PK[foodindex[i],hazardindexK[h]]*pK[,hazardindexK[h],foodindex[i]]*ppred[,foodindex[i]],c(0.025,0.5,0.975),names=FALSE),3) ))
           } # end of if density
           ...
           if(input$selectdist=="Cumulative"){
             ...
             if(scale=="Logarithmic"){
               ...
               maxx <- quantile(logRK[foodindex[i],hazardindexK[h]]+mus0[,foodindex[i]]
                            ...
                            +0.5*sigcK[,hazardindexK[h],foodindex[i]]^2
                            +2*sqrt(Ss0[,foodindex[i],foodindex[i]]),0.975,names=FALSE)
               plot(logmeanexposure/log(10),cump,main=paste(hazardnamesusedK[h],"from",foodnamesused[i],"(chronic)"),xlab="logC.exposure/bw+",ylab="",xlim=c(minn/log(10),maxx/log(10)),lwd=3,type="l") 
             ...
             legend("bottomright",paste(c("expo(%) 2.5%p","expo(%) 50%p","expo(%) 97.5%p"),round(quantile(100*PK[foodindex[i],hazardindexK[h]]*pK[,hazardindexK[h],foodindex[i]]*ppred[,foodindex[i]],c(0.025,0.5,0.975),names=FALSE),3) ))               
           } # end of if cumulative
         }} # end of for nhused nfused
     } 
     ...
     if((nhusedM>0)&(nfused>0)){
       ...
       for(h in 1:nhusedM){
         for(i in 1:nfused){
           ...
           if(input$selectscale=="Logarithmic"){
             ...
             minn = quantile(logRM[foodindex[i],hazardindexM[h]]+mus0[,foodindex[i]]
                         ...
                         +muw-2*sqrt(Ss0[,foodindex[i],foodindex[i]]
                                           ...
                                           +sigcM[,hazardindexM[h],foodindex[i]]^2
                                           +sigw^2),0.975,names=FALSE)
             plot(density(logmeanexposure/log(10)),main=paste(hazardnamesusedM[h],"from",foodnamesused[i],"(acute)"),xlab="logA.exposure+",ylab="",xlim=c(minn/log(10),maxx/log(10)) ) 
             polygon(density(logmeanexposure/log(10)),col="lightgray")
             mc <- round(seq(1,input$Iterations-burnin,length=25),0)
             for(n in 1:25){ # variability distributions for acute exposure
               lines(seq(minn/log(10),maxx/log(10),length=100),
           ...
           legend("topright",paste(c("expo(%) 2.5%p","expo(%) 50%p","expo(%) 97.5%p"),round(quantile(100*PM[foodindex[i],hazardindexM[h]]*pM[,hazardindexM[h],foodindex[i]]*ppred[,foodindex[i]],c(0.025,0.5,0.975),names=FALSE),3) ))
           } # end of if density
           ...
           if(input$selectdist=="Cumulative"){
             ...
             if(input$selectscale=="Logarithmic"){
               ...
               minn <- quantile(logRM[foodindex[i],hazardindexM[h]]+mus0[,foodindex[i]]
                         ...
                         +muw-2*sqrt(Ss0[,foodindex[i],foodindex[i]]
                            ...
                            +sigcM[,hazardindexM[h],foodindex[i]]^2
                            +sigw^2),0.975,names=FALSE)
               plot(logmeanexposure/log(10),cump,main=paste(hazardnamesusedM[h],"from",foodnamesused[i],"(acute)"),xlab="logA.exposure+",ylab="",xlim=c(minn/log(10),maxx/log(10)),lwd=3,type="l") 
             ...
             legend("bottomright",paste(c("expo(%) 2.5%p","expo(%) 50%p","expo(%) 97.5%p"),round(quantile(100*PM[foodindex[i],hazardindexM[h]]*pM[,hazardindexM[h],foodindex[i]]*ppred[,foodindex[i]],c(0.025,0.5,0.975),names=FALSE),3) ))
            } # end of if cumulative
         }} # end of nhusedM nfused
     } # end of if nhusedM nfused >0
   ...
   #########################################################
   output$distPlot4 = renderPlot({
     # generate results based on inputs from ui.R:  uncertainties of variability quantiles
    ...
    # evaluate quantiles for each of those variability distributions:
     ...
     if(input$modelchoice == "Independent days"){
       ...
       if(input$selectscale=="Absolute"){
       #########################################
       plot(ecdf(exposurevarsample[1,1:nV]),verticals=TRUE,do.points=FALSE,yaxt="s",xlim=c(min(exposurevarsample[1:thin,1:nV]),max(exposurevarsample[1:thin,1:nV])),lwd=1,lty=3,col=rgb(0.816,0.004,0.435),xlab="C.exposure/bw+",ylab="",main=paste("Exposure:",hazardnamesusedK[h],"total from",nfused,"foods"))
       for(a in 2:thin){
       lines(ecdf(exposurevarsample[a,1:nV]),verticals=TRUE,do.points=FALSE,lwd=1,lty=3,col=raspberry)     
       }
         quplim <- quantile(Qplus[,h],0.95,names=FALSE)
       ...
       lines(quantile(Qplus[,h],c(0.05,0.05),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
       lines(quantile(Qplus[,h],c(0.95,0.95),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
       legend("topright",title=paste("Total chronic",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),c(round(quantile(Q[,h],c(0.05,0.5,0.95),names=FALSE),2)) )) 
       legend("bottomright",title=paste("Positives chronic",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(Qplus[,h],c(0.05,0.5,0.95),names=FALSE,na.rm=TRUE),2) ))
       }
       if(input$selectscale=="Logarithmic"){
       plot(ecdf(log(exposurevarsample[1,1:nV])/log(10)),verticals=TRUE,do.points=FALSE,yaxt="s",xlim=c(min(log(exposurevarsample[1:thin,1:nV])/log(10)),max(log(exposurevarsample[1:thin,1:nV])/log(10))),lwd=1,lty=3,col=raspberry,ylab="",xlab="logC.exposure/bw+",main=paste("Exposure:",hazardnamesusedK[h],"total from",nfused,"foods"))
       for(a in 2:thin){
       lines(ecdf(log(exposurevarsample[a,1:nV])/log(10)),verticals=TRUE,do.points=FALSE,lwd=1,lty=3,col=raspberry)     
       }
         quplim <- quantile(log10(Qplus[,h]),0.95,names=FALSE)
       ...
       lines(quantile(log10(Qplus[,h]),c(0.05,0.05),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
       lines(quantile(log10(Qplus[,h]),c(0.95,0.95),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
       legend("topright",title=paste("Total chronic",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),c(round(quantile(log10(Q[,h]),c(0.05,0.5,0.95),names=FALSE),2)) )) 
       legend("bottomright",title=paste("Positives chronic",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(log10(Qplus[,h]),c(0.05,0.5,0.95),names=FALSE,na.rm=TRUE),2) ))
       }    
       } # uncertainty distribution of Q% exposure for hth chemical
     ...
     if(input$modelchoice == "Dependent days"){
       ...
       for(h in 1:nhusedK){
         if(input$selectscale=="Absolute"){
         plot(ecdf(exposurevarsample[1,1:nV]),verticals=TRUE,do.points=FALSE,yaxt="s",xlim=c(min(exposurevarsample[1:thin,1:nV]),max(exposurevarsample[1:thin,1:nV])),lwd=1,lty=3,col=raspberry,xlab="C.exposure/bw+",ylab="",main=paste("Uncertainty of distribution:",hazardnamesusedK[h],"total from",nfused,"foods"))
         for(a in 2:thin){
            lines(ecdf(exposurevarsample[a,1:nV]),verticals=TRUE,do.points=FALSE,lwd=1,lty=3,col=raspberry)     
         }
           quplim <- quantile(Qplus[,h],0.95,names=FALSE)
           ...
           lines(quantile(Qplus[,h],c(0.05,0.05),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
           lines(quantile(Qplus[,h],c(0.95,0.95),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
         legend("topright",title=paste("Total chronic",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(Q[,h],c(0.05,0.5,0.95),names=FALSE),2) ))
         legend("bottomright",title=paste("Positives chronic",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(Qplus[,h],c(0.05,0.5,0.95),names=FALSE,na.rm=TRUE),2) ))
         }
         if(input$selectscale=="Logarithmic"){
         plot(ecdf(log(exposurevarsample[1,1:nV])/log(10)),verticals=TRUE,do.points=FALSE,yaxt="s",xlim=c(min(log(exposurevarsample[1:thin,1:nV])/log(10)),max(log(exposurevarsample[1:thin,1:nV])/log(10))),lwd=1,lty=3,col=raspberry,ylab="",xlab="logC.exposure/bw+",main=paste("Uncertainty of distribution:",hazardnamesusedK[h],"total from",nfused,"foods"))
         for(a in 2:thin){
          lines(ecdf(log(exposurevarsample[a,1:nV])/log(10)),verticals=TRUE,do.points=FALSE,lwd=1,lty=3,col=raspberry)     
         }    
           quplim <- quantile(log10(Qplus[,h]),0.95,names=FALSE)
           ...
           lines(quantile(log10(Qplus[,h]),c(0.05,0.05),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
           lines(quantile(log10(Qplus[,h]),c(0.95,0.95),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
         legend("topright",title=paste("Total chronic",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(log(Q[,h])/log(10),c(0.05,0.5,0.95),names=FALSE),2) ))
         legend("bottomright",title=paste("Positives chronic",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(log10(Qplus[,h]),c(0.05,0.5,0.95),names=FALSE,na.rm=TRUE),2) ))
         }
       } # end of uncertainty distribution of Q% exposure for hth chemical
     ...
     if((nhusedM>0)&(nfused>0)){  # Microbial exposure quantiles
       ...
       if(input$modelchoice == "Independent days"){
         ...
         for(h in 1:nhusedM){
           if(input$selectscale=="Absolute"){
             if(sum(!is.na(exposurevarsample[1,]))>0){
             plot(ecdf(exposurevarsample[1,!is.na(exposurevarsample[1,])]),verticals=TRUE,do.points=FALSE,yaxt="s",xlim=c(min(exposurevarsample[1:thin,1:max(nplus)],na.rm=TRUE),0.1*max(exposurevarsample[1:thin,1:max(nplus)],na.rm=TRUE)),lwd=1,lty=3,col=raspberry,xlab="A.dose+",ylab="",main=paste("Exposure:",hazardnamesusedM[h],"total from",nfused,"foods"))
             }
             for(a in 2:thin){
             if(sum(!is.na(exposurevarsample[a,]))>0){   
             lines(ecdf(exposurevarsample[a,!is.na(exposurevarsample[a,])]),verticals=TRUE,do.points=FALSE,lwd=1,lty=3,col=raspberry)     
             ...
             lines(quantile(Qplus[,h],c(0.05,0.05),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
             lines(quantile(Qplus[,h],c(0.95,0.95),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
           legend("topright",title=paste("Total acute",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(Q[,h],c(0.05,0.5,0.95),names=FALSE,na.rm=TRUE),2) ))
           legend("bottomright",title=paste("Positives acute",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(Qplus[,h],c(0.05,0.5,0.95),names=FALSE,na.rm=TRUE),2) ))
           }
           
           if(input$selectscale=="Logarithmic"){
             if(sum(!is.na(exposurevarsample[1,]))>0){
               plot(ecdf(log10(exposurevarsample[1,!is.na(exposurevarsample[1,])])),verticals=TRUE,do.points=FALSE,yaxt="s",xlim=c(log10(min(exposurevarsample[1:thin,1:max(nplus)],na.rm=TRUE)),log10(max(exposurevarsample[1:thin,1:max(nplus)],na.rm=TRUE))),lwd=1,lty=3,col=raspberry,xlab="logA.dose+",ylab="",main=paste("Exposure:",hazardnamesusedM[h],"total from",nfused,"foods"))
             }
             for(a in 2:thin){
               if(sum(!is.na(exposurevarsample[a,]))>0){   
                 lines(ecdf(log10(exposurevarsample[a,!is.na(exposurevarsample[a,])])),verticals=TRUE,do.points=FALSE,lwd=1,lty=3,col=raspberry)     
             ...
             lines(quantile(log10(Qplus[,h]),c(0.05,0.05),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
             lines(quantile(log10(Qplus[,h]),c(0.95,0.95),names=FALSE,na.rm=TRUE),c(0,1),lwd=3)
             legend("topright",title=paste("Total acute",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(log10(Q[,h]),c(0.05,0.5,0.95),names=FALSE,na.rm=TRUE),2) ))
             legend("bottomright",title=paste("Positives acute",theQ,"% quantile:"),paste(c("5%p","50%p","95%p"),round(quantile(log10(Qplus[,h]),c(0.05,0.5,0.95),names=FALSE,na.rm=TRUE),2) ))
           }
           } # end of uncertainty distribution of Q% exposure for hth microbe
       } # end of if independent days
